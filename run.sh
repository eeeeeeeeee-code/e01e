...
git clone https://github.com/EASY233/Finger ./tools/Finger
pip install -r ./tools/Finger/requirements.txt
<<<<<<< HEAD
=======
echo '''
#!/usr/bin/env python
...
class Output:
    def __init__(self):
        ...
        path.output = path.output + "/../../../result"
